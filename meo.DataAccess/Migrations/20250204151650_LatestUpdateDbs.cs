...
{
    /// <inheritdoc />
    public partial class LatestUpdateDbs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    portalCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "CompanyID", "CompanyCity", "CompanyName", "CompanyPostalCode", "CompanyState", "CompanyStreetAddress", "companyImage" },
                values: new object[,]
                {
                    { 1, "TechCity", "Tech Innovators", "90210", "CA", "123 Innovation Lane", "" },
                    { 2, "FutureTown", "NextGen Solutions", "10001", "NY", "456 Future Blvd", "" }
                });
